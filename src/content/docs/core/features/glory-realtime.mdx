...
- Documenta en la documentación de tu tema (p. ej. el README del tema) los canales que usa y el formato esperado de las respuestas cuando el cliente solicite datos.
