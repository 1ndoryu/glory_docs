...
- Fuera de `dev_mode` los resultados pueden ser cacheados para mejorar rendimiento; dentro de `dev_mode` se fuerza
  la lectura directa para facilitar el desarrollo.
