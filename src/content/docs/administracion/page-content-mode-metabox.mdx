...
// Definir página gestionada
PageManager::define('acerca-de', 'render_pagina_acerca_de');
...
class PaginaGestionada
{
    ...
    public function setupPages(): void
    {
        ...
        PageManager::define('servicios', [$this, 'renderServicios']);

        // Página de contacto - puede ser editada
        PageManager::define('contacto', [$this, 'renderContactoBase']);
    }
...
```php
<?php
// El metabox solo aparece para páginas definidas con PageManager
PageManager::define('mi-pagina', 'mi_handler_function');
