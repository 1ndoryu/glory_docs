...
description: Sistema de filtrado dinámico con AJAX, ordenamiento, paginación y acciones masivas para data grids
---
...
Sistema avanzado de filtrado dinámico que proporciona filtrado en tiempo real, ordenamiento por columnas, paginación AJAX y acciones masivas para tablas de datos, todo sin recargar la página.
...
- **Paginación AJAX**: Navegación sin recarga de página
- **Acciones masivas**: Operaciones en múltiples elementos seleccionados
- **Selección completa**: Checkbox "Seleccionar todo"
...
- **Fragments dinámicos**: Actualización selectiva de elementos
- **Integración WordPress**: Compatible con admin-ajax.php
...
<div class="gloryDataGridContenedor">
    ...
    <div class="gloryDataGridAccionesMasivas">
        <select class="gloryGridBulkSelect">
            ...
            <option value="delete" data-ajax-action="bulk_delete" data-confirm="¿Eliminar elementos seleccionados?">
...
#### `data-ajax-action`
Acción AJAX que procesará los filtros (requerido).
...
```html
<th class="columnaOrdenable">
    <a href="?orderby=titulo&order=asc">Título</a>
</th>
```
...
Enlaces de paginación con atributo data-page.
...
<select class="gloryGridBulkSelect">
    <option value="delete"
            ...
            data-confirm="¿Confirmar eliminación?">
        Eliminar seleccionados
    </option>
</select>
```
...
#### `.gloryGridBulkApply`
Botón para ejecutar la acción masiva seleccionada.
...
#### `.gloryGridSelect`
Checkboxes individuales para selección.
...
#### `gloryFiltersInit()`
Inicializa el sistema de filtros (se llama automáticamente).
...
Dispara petición AJAX para un formulario específico.

```javascript
// Uso interno - normalmente automático
...
- **Submit del form**: Previene envío normal, usa AJAX
...
Los fragments permiten actualizar elementos específicos sin tocar toda la página.
...
### Eventos Automáticos
- **`gloryRecarga`**: Se dispara después de cada filtrado exitoso
...
- **Paginación**: Links con `data-page`
- **Acciones masivas**: Botón `.gloryGridBulkApply`
- **Seleccionar todo**: Checkbox `.gloryGridSelectAll`

## 🎯 Integración WordPress

### Función AJAX Handler
```php
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="columnaOrdenable">
                    <a href="?orderby=title&order=asc">Título</a>
                </th>
                <th class="columnaOrdenable">
    ...
    <div class="gloryDataGridAccionesMasivas">
        <select class="gloryGridBulkSelect">
            ...
            <option value="delete"
                    ...
                    data-confirm="¿Eliminar los posts seleccionados?">
                Eliminar seleccionados
            </option>
            <option value="draft"
...
3. **Paginación falla**: Verificar atributo `data-page` en enlaces
...
### Verificación de Handler AJAX
```php
// Añadir logging al handler
function manejar_filtros_ajax() {
...
- **Fragments**: Actualización selectiva, no de toda la página
- **Cache**: Respuestas AJAX pueden cachearse
- **Lazy loading**: Compatible con carga diferida de imágenes
- **Memory management**: Limpieza automática de timeouts

## 🔄 Compatibilidad

- ✅ **WordPress**: Integración completa con admin-ajax.php
- ✅ **jQuery**: Fallback para entornos legacy
- ✅ **Fetch API**: Modern browsers sin jQuery
- ✅ **Promises**: Manejo asíncrono consistente
- ✅ **Fragments**: Actualización selectiva de DOM
- ✅ **Event delegation**: Un solo listener global
- ✅ **Progressive enhancement**: Funciona sin JavaScript (form normal)
