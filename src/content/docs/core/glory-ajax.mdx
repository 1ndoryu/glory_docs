...
¿Quieres que añada ejemplos concretos del tema (ej. `tema-exportar-reservas.js` y `visualizacionPorFechaCallback`) y los enlace desde aquí? Si confirmas, los incluyo y subo.
