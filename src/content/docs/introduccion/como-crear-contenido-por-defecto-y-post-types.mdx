...
// Forma simple con build() (recomendada)
DefaultContentManager::define('libro', DefaultContentManager::build([
  // [titulo, imagen, descripcion]
  ['El Principito', 'elements::libros/principito.jpeg', 'Una novela poética...'],
  ['Las 48 Leyes', 'elements::libros/48leyes.png', 'Un libro sobre poder...'],
], [
